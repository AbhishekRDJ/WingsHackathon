...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  Future<void> _sendFeedback() async {
    ...
    HapticFeedback.lightImpact(); // Adds haptic feedback on button press
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        iconTheme:
            IconThemeData(color: Colors.brown.shade900), // Back button color
      ),
              ...
              Container(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  dropdownColor: Colors.brown.shade100
                      .withOpacity(0.8), // Soft brown dropdown
              ...
              Container(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.brown.shade700, // Rich brown button
  ...
  BoxDecoration _glassEffect() {
    return BoxDecoration(
      color: Colors.brown.shade100.withOpacity(0.8), // Soft brown background
      borderRadius: BorderRadius.circular(12),
